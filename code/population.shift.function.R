## modified from package AlleleShift
                                                                               ...
                                                                               "RDA"), vector.multiply = 1)
{
  ...
  # BioR.theme <- ggplot2::theme(panel.background = ggplot2::element_blank(), 
  #                              panel.border = ggplot2::element_blank(), panel.grid = ggplot2::element_blank(), 
  #                              axis.line = ggplot2::element_line("gray25"), text = ggplot2::element_text(size = 12), 
  #                              axis.text = ggplot2::element_text(size = 15, colour = "gray40"), 
  #                              axis.title = ggplot2::element_text(size = 15, colour = "gray40"), 
